...
public class IndexController {
	...
	//스프링 시큐리티 해당주소를 낚아채버린다. !! 설정을 해줘여한다. 
	// SecurityConfig파일 생성 후 작동 안 함.
	...
	public String join(User user) {
		...
		userRepository.save(user);   //회원가입이 잘되지만 시큐리티로 로그인할 수 없다.
		// 이유는 패스워드가 암호화가 안되어 있기 때문이다.
  ...
  // @Secured는 하나만 걸때 ,   @PreAuthorize은  두개 이상 걸때
